...
public enum ExceptionEnum {
    ...
    PAGE_CREATE_ERROR(500, "静态页面创建失败！"),
    PAGE_DELETE_ERROR(500, "静态页面删除失败!"),
    INDEX_CREATE_ERROR(500, "商品索引创建失败!"),
    INDEX_DELETE_ERROR(500, "商品索引删除失败!"),

    USER_NOT_FOUND(400, "用户不存在！"),
    USER_DATA_CHECK_ERROR(500, "用户数据校验失败！");
